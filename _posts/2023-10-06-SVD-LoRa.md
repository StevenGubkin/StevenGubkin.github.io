...
Let $$U$$ be a $$d \times i$$ matrix whose columns are orthonormal and span $$\mathcal{U}$$.  Similarly, let $W$ be a $$d \times j$$ matrix whose columns are orthonormal and span $$\mathbb{W}$$.
...
This was out **definition** of the first singular value of $$P$$, so we have:
...
Note:  it is a nice exercise to prove the equivalence of these three.  If you have been working through everything so far it shouldn't be out of your reach to prove this.
